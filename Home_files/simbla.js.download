    ...
    try {
        ...
        if (o.data('criteria')) {
            ...
            criteria.forEach(function (f) {
                ...
                if (f.P && f.P.targetClass === "_User" && val === "currentUser" && Simbla.User.current())
        ...
        actions.forEach(function (a) {
            ...
            switch (a.action) {
                ...
                case "required":
                    ...
                    break;
                case 'hidden':
                    if (field.data('origin-hidden') === undefined) field.data('origin-hidden', !field.closest('.form-group').is(':visible'))
                    field.closest('.form-group').hide();
                    break;
                case 'fixed-value':
                    //if (!field.val())
            ...
            ajax: {
                transport: function (params, success, failure) {
                    ...
                    selectTimeout = setTimeout(function () {
                        ...
                        q.select.apply(q, searchKyes).limit(15);
                        try {
